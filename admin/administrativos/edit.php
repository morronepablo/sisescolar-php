...
global $nombres, $apellidos, $roles, $nombre_rol, $ci, $fecha_nacimiento, $celular, $profesion, $email, $direccion, $id_usuario, $id_persona;
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="form-inline">
                                                ...
                                                <select name="rol_id" id="" class="form-control" style="width: 80%">
                                                    <?php
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <a href="<?=APP_URL;?>/admin/administrativos" class="btn btn-outline-secondary">Cancelar</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
