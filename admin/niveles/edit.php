...
global $nivel, $gestiones, $gestion_id, $turno;
$id_nivel = $_GET['id'];
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="nivel" id="" class="form-control">
                                                ...
                                                <option value="TERCIARIO"<?php if($nivel == 'TERCIARIO') { ?> selected="selected" <?php } ?>>TERCIARIO</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <a href="<?=APP_URL;?>/admin/niveles" class="btn btn-outline-secondary">Cancelar</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
